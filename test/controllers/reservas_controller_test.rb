...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { cantidad: @reserva.cantidad, cliente: @reserva.cliente, fecha: @reserva.fecha, responsable: @reserva.responsable, sku: @reserva.sku }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { cantidad: @reserva.cantidad, cliente: @reserva.cliente, fecha: @reserva.fecha, responsable: @reserva.responsable, sku: @reserva.sku }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
